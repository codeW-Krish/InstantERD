...
import { MoreHorizontal, Copy, ShoppingBag, Users, CreditCard, Box } from "lucide-react";
                ...
                >
                  <div className="flex items-start justify-between gap-2">
                    ...
                    <motion.button
                      ...
                      className="group relative flex h-10 items-center justify-center overflow-hidden rounded-full bg-white/10
                                 px-4 py-2 font-bold backdrop-blur-md 
                    ...
                    >
                      <span className="relative inline-block transition-transform duration-300 ease-in-out group-hover:-translate-y-full">
                        <span className="flex items-center gap-1.5 opacity-100 transition-opacity duration-300 group-hover:opacity-0">
                          Copy <span className="hidden xs:inline">Schema</span> <Copy size={16} />
                        </span>
                        <span className="absolute top-full left-0 flex items-center gap-1.5 opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                          Copy <span className="hidden xs:inline">Schema</span> <Copy size={16} />
                        </span>
                      </span>
                    </motion.button>
                  ...
                  <div className="flex items-end justify-between mt-4">
                    ...
                    <button
                      ...
                      className="group relative flex h-8 sm:h-9 items-center justify-center overflow-hidden rounded-full bg-white/30 px-4 py-1.5
                                 text-xs sm:text-sm font-bold backdrop-blur-md 
                                 hover:bg-white/40 transition-colors shrink-0"
                    >
                      <span className="relative inline-block transition-transform duration-300 ease-in-out group-hover:-translate-y-full">
                        <span className="block opacity-100 transition-opacity duration-300 group-hover:opacity-0">Edit</span>
                        <span className="absolute top-full left-0 block opacity-0 transition-opacity duration-300 group-hover:opacity-100">Edit</span>
                      </span>
                    </button>
                  </div>
                </motion.div>
