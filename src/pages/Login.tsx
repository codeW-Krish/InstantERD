...
import { Mail, Lock, ArrowLeft, ArrowRight, Merge, AlertCircle } from "lucide-react";
      ...
      >
        <TextureCardStyled className="border-paper/5 bg-blueprint/60 backdrop-blur-2xl">
          <TextureCardHeader className="flex flex-col gap-1 items-center justify-center p-8">
            ...
            <TextureCardTitle className="text-3xl">Welcome Back</TextureCardTitle>
            <p className="text-center font-mono text-[10px] uppercase tracking-widest text-paper/40 mt-2">
              Access your architectural blueprints
            </p>
          </TextureCardHeader>
            ...
            <form className="space-y-5" onSubmit={handleLogin}>
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center px-1">
                  <label className="font-mono text-[10px] uppercase tracking-widest text-paper/60">Password</label>
                  <a href="#" className="font-mono text-[10px] uppercase tracking-widest text-emerald-accent hover:underline">Forgot?</a>
                </div>
                <div className="relative group">
              ...
              <TextureButton variant="accent" className="w-full h-14 mt-4" hoverText={isLoading ? "Authenticating..." : "Initialize Session"} type="submit" disabled={isLoading}>
          ...
          <TextureCardFooter className="p-8 pt-0 flex flex-col gap-6">
            <div className="w-full bg-paper/5 rounded-2xl p-4 border border-paper/5">
              <p className="text-center font-mono text-[10px] uppercase tracking-widest text-paper/40">
                New to InstantERD?{" "}
                <Link to="/signup" className="text-emerald-accent hover:underline">Create Account</Link>
              </p>
            </div>
            
            <div className="text-center">
              <span className="font-mono text-[8px] uppercase tracking-[0.4em] text-paper/20">
                Secured by Blueprint Protocol
              </span>
            </div>
          </TextureCardFooter>
        </TextureCardStyled>
